  ...
  return (
    <header className="bg-background border-border/50 sticky top-0 z-40 flex h-14 w-full shrink-0 items-center border-b px-3 sm:px-4">
      ...
      <div className="ml-auto flex items-center gap-x-1.5 sm:gap-x-2">
        ...
        <div
          className={cn(
            "hidden items-center rounded-full border px-2.5 py-1 text-[11px] font-semibold transition-colors duration-200 motion-reduce:transition-none sm:flex",
            isOnline
        ...
        >
          <span
            className={cn(
              ...
              isOnline ? "animate-pulse bg-green-500" : "animate-pulse bg-red-500",
