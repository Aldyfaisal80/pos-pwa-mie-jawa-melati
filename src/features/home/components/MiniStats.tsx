...
export const MiniStats = () => {
  ...
  const hasOffline = pendingCount > 0;
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-4">
      ...
      <Card className="transition-shadow duration-200 hover:shadow-md">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-muted-foreground flex items-center gap-1.5 text-xs font-medium sm:text-sm">
            Omzet Hari Ini
            {hasOffline && <OfflineDot />}
          </CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground mt-1 flex items-center gap-1 text-xs">
            ...
            {hasOffline ? "Termasuk data offline" : "Data real dari server"}
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="transition-shadow duration-200 hover:shadow-md">
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground mt-1 text-xs">
            {hasOffline ? `Termasuk ${pendingCount} offline` : "Transaksi hari ini"}
          </p>
        </CardContent>
      </Card>
    </div>
